...
function mapDispatchToProps(dispatch) {
  return {
    ...
    save: (action) => {
      dispatch(fetchPostsIfNeeded("characterImage/save/", types.SAVE_CHARACTER_LIST, action))
    },
    delete: (id) => {
      dispatch(fetchPostsIfNeeded("characterImage/delete/" + id, types.DELETE_CHARACTER_LIST, {}, {imageType: IMAGE_DISPLAY_TYPE_CHARACTER}))
    },
    upload: (formData) => {
      dispatch(fetchUploadIfNeeded("characterImage/upload/", types.UPLOAD_CHARACTER_LIST, formData)).then(() => {
        dispatch(fetchPostsIfNeeded("characterImage/list/", types.GET_CHARACTER_LIST, {}, {imageType: IMAGE_DISPLAY_TYPE_CHARACTER}))
      })
    },
