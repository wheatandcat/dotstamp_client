...
export default class Edit extends Component {
   ...
   */
  render() {
    return (<FormHeader title={this.props.contributionEdit.title} viewStatus={this.props.contributionEdit.ViewStatus} contributionId={this.props.contributionEdit.id} contributionTalk={this.props.contributionTalk} sound={this.props.contributionEdit.Sound}/>)
  }
}
