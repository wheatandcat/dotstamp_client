    ...
    if (talk.TalkType == TALK_TYPE_IMAGE) {
      edit = (
        <Button>
          ...
          <input type="file" id={"image-file-edit-" + talk.Priority} name="image-file-edit" className="hidden" accept="image/jpeg,image/png,image/jpg" onChange={this.handleChangeFile.bind(this)}/>
        </Button>
      )
    } else {
      edit = (
